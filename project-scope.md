...
## Problem
We receive hundreds of support emails daily. Agents manually read, classify, and respond to each ticket, which is slow and can lead to impersonal, canned responses.
...
## Users and Roles
The system should be deployed with an initial admin user.

The admin can create additional agent users.
